...
[![verified](https://img.shields.io/badge/verified-81%20checks%20%2B%2010%2F11%20mutations-7a3355?style=for-the-badge)](https://github.com/pixie-chan)
...
| 11 | Stack: Concept and array representation | `learning/dsa/stack-guide.html` | 🟡 partial |
| 12 | Stack using Linked List, Stack Application | gap | 🔴 |
| 13 | Queue: Concepts and Array Representation | gap | 🔴 |
| 14 | Queue using Linked List and Circular Queue | gap | 🔴 |
| 15 | Queue Applications | gap | 🔴 |
| 16 | Recursion and Recursive Algorithms | `learning/cpp/lessons/09_recursion_frames.cpp` (measured frames) | 🟡 partial |
...
│   ├── Notes/intro-memory/       lecture 5 visual guide + notes + diagrams + tokens
│   ├── Notes/linked-list/        lectures 6 to 8 notes + 4 mermaid diagrams
│   ├── Notes/midterm-roadmap/    the mid-term dossier (HTML) + 4 rendered diagrams
│   ├── Notes/DSA-STUDY-PLAN.md   18 week mastery plan
│   └── Notes/C++-LANGUAGE-PLAN.md
├── das-lab/                      ELC2132 lab: Exp0 to Exp4 sources and captured outputs
├── learning/
│   ├── cpp/lessons/              lesson programs, lecture mapped (01 .. 09)
│   ├── cpp/exercises/            verifiers and captured run output
...
| gate screenshots (`.qa/*.png`) | megabytes of pixels that any run reproduces |
